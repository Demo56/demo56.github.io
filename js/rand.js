...
function getImg() {
    ...
    if (!usedImages[randomNum]) {
        ...
        var myImgSrc = document.getElementById("result").getElementsByTagName("img")[0].src.slice(40);
...
function getImg2() {
    ...
    if (!usedImages[randomNum]) {
        ...
        var myImgSrc = document.getElementById("result2").getElementsByTagName("img")[0].src.slice(40);
        var myImgName = decodeURIComponent (myImgSrc.split('.', [1]));
