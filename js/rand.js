...
function getImg2() {
    ...
    if (!usedImages[randomNum]) {
        ...
        var myImgSrc = document.getElementById("result2").getElementsByTagName("img")[0].src.slice(36);
        var myImgName = decodeURIComponent (myImgSrc.split('.', [1]));
...
function getImg3() {
    ...
    if (!usedImages[randomNum]) {
        ...
        var myImgSrc = document.getElementById("result3").getElementsByTagName("img")[0].src.slice(36);
        var myImgName = decodeURIComponent (myImgSrc.split('.', [1]));
